...
public class gameplay extends JPanel implements KeyListener, ActionListener { 
	...
	private int [] enemyxpos = {25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 
			...
			600, 625, 650, 675, 700, 750, 775, 800, 850};
	...
	private void setFocusTraversalKeyEnabled() {
	...
	public void paint(Graphics g) {
		...
		for(int a = 0; a < lengthofsnake; a++) { 
			...
			if(a != 0) { 
				...
				circle = new ImageIcon("circle2.png");
				circle.paintIcon(this, g, snakexlength[a], snakeylength[a]);
